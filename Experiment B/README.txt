### This folder contains everything you need to know about experiment B ###

You run on matlab the file Experiment.m
and you load any of the 18 experiments located on the same folder.
The experiments called AlessioX are with human around.
The experiments called onetagX are with no human around (I switch the tag's position
between the side of my body and in front of my body)
